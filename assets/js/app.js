!function(a) {
        ...
        t.forEach(function(r) {
            !function t() {
                var e = +r.getAttribute("data-target")
                  ...
                  , n = e / 250;
                n < 1 && (n = 1),
                a < e ? (r.innerText = (a + n).toFixed(0),
                setTimeout(t, 1)) : r.innerText = e
            }()
        })
    }
    function d() {
    ...
    a("#mode-setting-btn").on("click", function(t) {
        n.hasAttribute("data-bs-theme") && "dark" == n.getAttribute("data-bs-theme") ? (document.body.setAttribute("data-bs-theme", "light"),
        ...
        l("topbar-color-light")) : (document.body.setAttribute("data-bs-theme", "dark"),
    ...
    n.hasAttribute("data-layout") && "horizontal" == n.getAttribute("data-layout") ? (l("layout-horizontal"),
    a(".sidebar-setting").hide()) : l("layout-vertical"),
    ...
    n.hasAttribute("data-sidebar-size") && "sm" == n.getAttribute("data-sidebar-size") ? l("sidebar-size-small") : n.hasAttribute("data-sidebar-size") && "md" == n.getAttribute("data-sidebar-size") ? l("sidebar-size-compact") : l("sidebar-size-default"),
    n.hasAttribute("data-sidebar") && "brand" == n.getAttribute("data-sidebar") ? l("sidebar-color-brand") : n.hasAttribute("data-sidebar") && "dark" == n.getAttribute("data-sidebar") ? l("sidebar-color-dark") : l("sidebar-color-light"),
    ...
    a("input[name='layout-mode']").on("change", function() {
        "light" == a(this).val() ? (document.body.setAttribute("data-bs-theme", "light"),
        document.body.setAttribute("data-topbar", "light"),
        document.body.setAttribute("data-sidebar", "light"),
        n.hasAttribute("data-layout") && "horizontal" == n.getAttribute("data-layout") || document.body.setAttribute("data-sidebar", "light"),
        l("topbar-color-light"),
        l("sidebar-color-light")) : (document.body.setAttribute("data-bs-theme", "dark"),
        document.body.setAttribute("data-topbar", "dark"),
        document.body.setAttribute("data-sidebar", "dark"),
        n.hasAttribute("data-layout") && "horizontal" == n.getAttribute("data-layout") || document.body.setAttribute("data-sidebar", "dark"),
        l("topbar-color-dark"),
